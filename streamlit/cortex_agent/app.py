...
SERVICES = [
    {
        "name": "PATIENT_DATA",
        "location": "DEFAULT_DATABASE.DEFAULT_SCHEMA.PATIENT_DATA",
        #"title_column": "RELATIVE_PATH", #optional
        "id_column": "NHS_NUMBER", #optional
        "type": "search",
        "emoji": "🔍",
        "max_results": 3,
    },
    {
        ...
        "location": "DEFAULT_DATABASE.DEFAULT_SCHEMA.RESEARCH_PAPERS",
        "title_column": "TITLE_OF_PAPER", #optional
        #"id_column": "NHS_NUMBER", #optional
        "type": "search",
        "emoji": "🔍",
        "max_results": 3,
    ...
    {
        "name": "Patient Digital Data",
        "location": "DEFAULT_DATABASE.CORTEX_ANALYST.CORTEX_ANALYST/semantic_model.yaml",
        "type": "analyst",
        "emoji": "📊",
    },
...
CUSTOM_INSTRUCTION = (
    """You are a helpful agent called Health Agent. Use the full conversation content when answering. 
...
onboarding_q = '"What is the general health in the cornwall area?" or "How many of these have Asthma"'
...
class ChatService:
    ...
    def handle_user_prompt(self, prompt: str):
        with st.spinner('Health Agent is thinking...'):
...
def main():
    st.set_page_config(page_title="Health Agent", page_icon="❄️", layout="wide")
    ...
    with st.sidebar:
        ...
        st.markdown("### ⚙️ Health Agent Settings")
    ...
    if not state.messages:
        st.markdown(
            ...
            <div class="welcome-container">
                ...
                <div class="welcome-title">Health Agent</div>
    ...
    # ── user input ──
    if prompt := st.chat_input("Help me Health Agent, you're my only hope..."):
